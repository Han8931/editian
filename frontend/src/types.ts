...
export interface Skill {
  id: string
  name: string        // slash command name — no spaces, e.g. "formalize"
  description: string // one-line summary shown in the picker
  body: string        // the prompt template; may contain {{selection}}
}
