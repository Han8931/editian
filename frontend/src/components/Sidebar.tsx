...
export default function Sidebar({
  ...
  if (showSkills) {
    return (
      <aside className="border-l border-gray-200 bg-white flex flex-col flex-shrink-0" style={style}>
        <div className="h-12 px-4 border-b border-gray-200 flex items-center gap-3">
          <button onClick={() => { setShowSkills(false); setSkills(loadSkills()) }} className="text-gray-400 hover:text-gray-600 transition-colors" title={msg('back')}>
            <ArrowLeft size={16} />
          </button>
          <Zap size={14} className="text-blue-500" />
          <span className="font-medium text-gray-800">{msg('skills')}</span>
        </div>
        <SkillsManager onClose={() => { setShowSkills(false); setSkills(loadSkills()) }} />
      </aside>
    )
  }
    ...
    <aside className="border-l border-gray-200 bg-white flex flex-col flex-shrink-0" style={style}>
      ...
      {/* Header */}
        ...
        <div className="flex items-center gap-1">
          <button onClick={() => setShowSkills(true)} className="text-gray-400 hover:text-gray-600 transition-colors" title={msg('skills')}>
            <Zap size={15} />
          </button>
