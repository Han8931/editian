...
from latex_utils import detect_newline, read_latex_text, serialize_latex_blocks, split_latex_blocks


def apply_latex_revisions(
    input_path: str,
    output_path: str,
    ...
    original_text = read_latex_text(output_path)
    newline = detect_newline(original_text)
    trailing_newline = original_text.endswith(("\n", "\r"))
    blocks = split_latex_blocks(original_text)
    ...
    for revision in revisions:
        ...
        if scope_type == "document":
            blocks = split_latex_blocks(revised_text)
    ...
    rendered = serialize_latex_blocks(blocks, newline=newline, trailing_newline=trailing_newline)
